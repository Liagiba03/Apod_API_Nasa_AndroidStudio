 ...
 * Use the {@link FragmentSpirit#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentSpirit extends Fragment {
    ...
    TextView txtId;
    TextView txtCamara;
    TextView txtCamaraAbr;
    TextView txtFechaFoto;
    ImageView imgImagen;
    private TextInputEditText txtFechaBuscar;
    private FloatingActionButton btnBuscar;
    private FloatingActionButton btnLimpiar;

    private String URL_API="https://api.nasa.gov/mars-photos/api/v1/manifests/spirit?&api_key=fKOwxfUmLSy5qSjKzoZ6JVWWzTijEfvNFNXhRrLb";
    private String URL_API_BUSCAR="a";
    private static final String BASE_URL = "https://api.nasa.gov/";

    public FragmentSpirit() {
     ...
     * @return A new instance of fragment FragmentSpirit.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentSpirit newInstance(String param1, String param2) {
        FragmentSpirit fragment = new FragmentSpirit();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_spirit,container,false);
    ...
    //OBTENER LOS RECURSOS DE LAS IMAGENES
    private void obtenerRecursosDesdeAPIFecha() {
        //Se crea la instancia Retrofit
        Retrofit retro = new Retrofit.Builder()
                .baseUrl(BASE_URL)
                .addConverterFactory(ScalarsConverterFactory.create())
        ...
        //Hacer la llamada a la API con la URL creada
        Call<String> call = servicioAPI.obtenerJsonString(URL_API_BUSCAR);
        call.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
